...
<template>
    <div class="flex justify-center relative w-full">
        ...
        <div class="w-full relative grid grid-cols-1 gap-4 p-4 mb-8 border rounded-lg bg-white shadow-lg">
            ...
            <p class="-mt-4 text-gray-500 w-full">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
        </div>
    </div>
</template>